...
#   Wooldridge Boats Inc_ - Documents\LUKE - DANNY - GRANT - DATA POPULATION\
...
$src  = 'C:\Users\Stephen\OneDrive - Wooldridge Boats Inc\Wooldridge Boats Inc_ - Documents\LUKE - DANNY - GRANT - DATA POPULATION'
...
[void]$sb.AppendLine('   worksheets (LUKE - DANNY - GRANT - DATA POPULATION). CONFIRMED figures')
